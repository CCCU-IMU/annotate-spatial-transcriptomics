...
- Observation-level splitting is attempted without a candidate-specific direct discriminator or without reproduction of the proposed identities in at least one neighboring higher-resolution Leiden partition.
