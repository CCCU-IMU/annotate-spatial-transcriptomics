...
- Membership-partition fixtures must fail on duplicate direct returns, omitted cells, overlapping outcomes, an inexact targeted successor, an Atlas query different from terminal residual QC, or an Atlas accepted/rejected writeback mismatch.
