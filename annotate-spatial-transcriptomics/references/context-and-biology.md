...
Never write an entire cluster as Oocyte from ZP2/ZP3/ZP4 alone. Require cell-level co-detection of a multi-gene program including at least one identity/maternal-core marker, inspect contradictory granulosa/stromal/vascular/epithelial/immune programs, verify compact follicular spatial foci and recluster the complete contamination-safe targeted cohort. Calibrate numerical thresholds from the query and known anchors. A prevalence above the profile alert is a mandatory review trigger, not automatic rejection.
