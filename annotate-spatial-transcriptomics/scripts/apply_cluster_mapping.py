    ...
    with inp, out:
        ...
        for row in reader:
            ...
            writer.writerow({
                ...
                "strict_state": m.get("strict_state",m["state"]), "strict_broad_label": m.get("strict_broad_label",m["broad_label"]), "strict_fine_label": m.get("strict_fine_label",m["fine_label"]), "inclusive_state": m.get("inclusive_state",m["state"]), "inclusive_broad_label": m.get("inclusive_broad_label",m["broad_label"]), "inclusive_fine_label": m.get("inclusive_fine_label",m["fine_label"]), "display_state": m.get("display_state",m["state"]), "display_broad_label": m.get("display_broad_label",m["broad_label"]), "display_fine_label": m.get("display_fine_label",m["fine_label"]), "display_policy": m.get("display_policy","direct_same_all_views"),
