...
ALLOWED = ["PLANNED", "WORKER_ASSIGNED", "ANALYSIS_RUNNING", "READY_FOR_MASTER_SAMPLE_GATE", "SAMPLE_FROZEN", "CROSS_SAMPLE_AUDIT", "COHORT_CONFIRMATION_PENDING", "RELEASE_RUNNING", "RELEASED", "FAILED_PRESERVED"]
