...
def main() -> int:
    ...
    config = {
        ...
        "canonical_lineage_controller_version": "2.2.0",
        "formal_release_from_project_local_decision_scripts_forbidden": True,
        ...
        "observation_subset_writeback_required": True,
        "whole_subcluster_purity_evidence_required": True,
        "terminal_return_purity_audit_required": True,
        "raw_two_family_writeback_audit_required": True,
