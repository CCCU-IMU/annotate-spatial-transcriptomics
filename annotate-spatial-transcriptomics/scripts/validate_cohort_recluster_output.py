#!/usr/bin/env python3
"""Fail-closed validation for query-only cohort reclustering artifacts.

Historical runner filenames inside the output bundle remain readable adapters;
they do not define an active pool architecture.
"""
