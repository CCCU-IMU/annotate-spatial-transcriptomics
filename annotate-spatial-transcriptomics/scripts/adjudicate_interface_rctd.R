...
plot_dt <- d[, .(x, y, plot_label = fifelse(final_action == "validated_broad_return", final_broad_label, fifelse(final_action == "route_to_strict_oocyte_review_pool", "Strict Oocyte review", fifelse(final_action == "route_to_plasma_review_pool", "Plasma review", "QC holdout before anchor reclustering"))))]
pal <- c(Stromal = "#4DAF4A", `Stromal/vascular-associated` = "#377EB8", `Follicular somatic` = "#FF7F00", Theca = "#984EA3", Vascular = "#1F78B4", Immune = "#E31A1C", `Epithelial/mesothelial` = "#A65628", `Strict Oocyte review` = "#FB9A99", `Plasma review` = "#B15928", `QC holdout before anchor reclustering` = "#D0D0D0")
