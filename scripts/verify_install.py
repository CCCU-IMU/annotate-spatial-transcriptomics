...
REQUIRED = (
    ...
    "references/profiles/sheep_ovary_biological_quality_review.md",
    ...
    "schemas/catalog_wide_lineage_review.schema.json",
    "schemas/broad_family_evidence.schema.json",
    "schemas/residual_qc_audit.schema.json",
    "schemas/sheep_ovary_biological_quality_review.schema.json",
    ...
    "scripts/lineage_controller_lib.py",
    "scripts/run_observation_lineage_scoring.R",
    "scripts/derive_candidate_local_subsets.R",
    "scripts/close_exact_remainders.py",
    "scripts/audit_catalog_wide_lineage_challengers.py",
    "scripts/validate_catalog_wide_lineage_review_decisions.py",
    "scripts/apply_catalog_wide_lineage_review.py",
    "scripts/run_lineage_controller.py",
    "scripts/select_lineage_resolution.py",
    "scripts/build_resolution_grid_evidence.py",
    "scripts/extract_seurat_partition_grid.R",
    "scripts/discover_unmodeled_lineages.py",
    "scripts/validate_lineage_controller_release.py",
    "scripts/validate_sheep_ovary_biological_quality.py",
    "scripts/apply_sheep_ovary_follicle_roi_repair.py",
    "scripts/screen_rare_cell_programs.R",
    "scripts/screen_spatial_foci.py",
    "scripts/materialize_oocyte_cluster_membership.py",
    "scripts/apply_cell_id_membership_patch.py",
    "scripts/write_frozen_annotations_to_seurat.R",
    "scripts/build_frozen_review_report.py",
    "scripts/build_release_evidence_tables.py",
