...
def main() -> int:
    ...
    required = [
        ...
        SKILL / "scripts" / "audit_catalog_wide_lineage_challengers.py",
        SKILL / "scripts" / "validate_catalog_wide_lineage_review_decisions.py",
        SKILL / "scripts" / "apply_catalog_wide_lineage_review.py",
        ...
        SKILL / "schemas" / "catalog_wide_lineage_review.schema.json",
